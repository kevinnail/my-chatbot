...
export class ChatManager {
  ...
  handleDemoMode({
    ...
    const writerDemoResponse =
      'This is the demo version of the Writing Assistant. In the local version, you share details about yourself - experiences, projects, the moments you remember, the ones that nag at you - and the assistant turns it into reflective prose you can use later for interviews, cover letters, or just to see your own story laid out in front of you.\n\nIt does not give advice. It does not coach. It writes about you, in your own material, building the kind of language you would not normally produce on demand. Run it locally to try it on your own story.';
